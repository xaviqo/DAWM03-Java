package bin.agendaxqo;

import bin.agendaxqo.dao.ContactDAO;
import bin.agendaxqo.generators.Generator;
import bin.agendaxqo.model.Contact;
import bin.agendaxqo.utilconsole.UtilConsole;
...
public class Main {
    ...
    // CFG //
    private static String dir = "/bin/agendaxqo/persistence/";
    private static String file = "agenda.xavi";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Binary-Agenda by Xavi Quiñones");
        System.out.println();
    ...
    private static ContactDAO daoCfg() {
        ...
        try {
            return new ContactDAO(System.getProperty("user.dir") , dir + file);
